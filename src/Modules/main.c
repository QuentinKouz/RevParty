...
/// @brief Fonction principale du programme pour exécuter différents modes de scrutin en fonction des arguments de la ligne de commande.
/// @param argc Nombre d'arguments de la ligne de commande.
/// @param argv Tableau de chaînes de caractères représentant les arguments de la ligne de commande.
